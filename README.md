...
Download latest Affise SDK [`attribution-1.7.3.unitypackage`](https://github.com/affise/affise-mmp-sdk-unity/releases/download/1.7.3/attribution-1.7.3.unitypackage)
...
target 'UnityFramework' do
  pod 'AffiseInternal', '1.7.3'

  # Affise Modules
  pod 'AffiseModule/AdService', '1.7.3'
  pod 'AffiseModule/Advertising', '1.7.3'
  pod 'AffiseModule/AppsFlyer', '1.7.3'
  pod 'AffiseModule/Link', '1.7.3'
  pod 'AffiseModule/Persistent', '1.7.3'
  pod 'AffiseModule/Status', '1.7.3'
  pod 'AffiseModule/Subscription', '1.7.3'
  pod 'AffiseModule/TikTok', '1.7.3'
end
