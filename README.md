...
Download latest Affise SDK [`attribution-1.7.4.unitypackage`](https://github.com/affise/affise-mmp-sdk-unity/releases/download/1.7.4/attribution-1.7.4.unitypackage)
...
target 'UnityFramework' do
  pod 'AffiseInternal', '1.7.4'

  # Affise Modules
  pod 'AffiseModule/AdService', '1.7.4'
  pod 'AffiseModule/Advertising', '1.7.4'
  pod 'AffiseModule/AppsFlyer', '1.7.4'
  pod 'AffiseModule/Link', '1.7.4'
  pod 'AffiseModule/Persistent', '1.7.4'
  pod 'AffiseModule/Status', '1.7.4'
  pod 'AffiseModule/Subscription', '1.7.4'
  pod 'AffiseModule/TikTok', '1.7.4'
end
