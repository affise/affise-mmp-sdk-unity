    ...
    public static class ProviderTypeExt
    {
        public static string Provider(this ProviderType param)
        {
            return param switch
            {
                ...
                ProviderType.SCREEN_WIDTH => "screen_width",
                ProviderType.SCREEN_HEIGHT => "screen_height",
                ProviderType.DENSITY => "density",
                ProviderType.CPU_CORES => "cpu_cores",
                ProviderType.TOTAL_DISK => "total_disk",
                ProviderType.FREE_DISK => "free_disk",
                ...
                ProviderType.AD_PERSONALIZATION => "ad_personalization",
                ProviderType.ADVERTISER_TRACKING_ENABLED => "advertiser_tracking_enabled",
                ProviderType.APPLICATION_TRACKING_ENABLED => "application_tracking_enabled",
